...
import CoreatorsTokenityCoreatorsTokenityBlog from './coreators/tokenity/coreators.tokenity.blog'
...
export default { 
  CoreatorsTokenityCoreatorsTokenityBlog: load(CoreatorsTokenityCoreatorsTokenityBlog, 'coreators.tokenity.blog'),
