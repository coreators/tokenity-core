# tokenity
**tokenity** is a blockchain built using Cosmos SDK and Tendermint and created with [Starport](https://starport.com).
...
```
curl https://get.starport.com/coreators/tokenity@latest! | sudo bash
```
